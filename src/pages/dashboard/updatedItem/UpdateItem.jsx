            ...
            <div>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className='form-control w-full my-6'>
                        ...
                        {/* <input type="text" defaultValue={item.name} placeholder='Recipe Name'  className='input input-bordered w-full' /> */}
                        <input defaultValue={item.name} type="text" placeholder='Name' {...register('name', { required: true })} className='input input-bordered w-full' />
                    </div>
                    <div className='flex gap-6'>
                        ...
                        <div className='form-control w-full my-6'>
                            ...
                            <input defaultValue={item.price} type="number" placeholder='Price' {...register('price', { required: true })} className='input input-bordered w-full' />
                        </div>
                    </div>
                    ...
                    <textarea defaultValue={item.recipe} name="" id="" className='textarea textarea-bordered w-full' placeholder='Bio' {...register('recipe')}></textarea>
                    <div className='form-control w-full my-6'>
